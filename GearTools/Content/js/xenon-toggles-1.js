...
{public_vars.$sidebarMenu.removeClass('collapsed');public_vars.$sidebarMenu.find('.has-sub.expanded').removeClass('expanded');ps_init();}
else
{public_vars.$sidebarMenu.addClass('collapsed');public_vars.$sidebarMenu.find('ul').removeAttr('style');ps_destroy();}
console.log('qyfte');$(window).trigger('xenon.resize');});});$('a[data-toggle="mobile-menu"]').on('click',function(ev)
